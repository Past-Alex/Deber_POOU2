...
public class PruebaAudioVisual {
    ...
    public static void main(String[] args) {
        ...
        contenidos[3] = new Cortometraje("Le voyage dans la lune", 15, "Fantasía", "Cinemateca Francesa", 1902);
        
        // **NUEVA SUBCLASE: VideoYoutube**
        contenidos[4] = new VideoYoutube("Introducción a la Recursividad", 9, "Algoritmos", "Universidad Online CS", 3500L);
